  ...
  render(){ 
    return (    //JSX
      <header className="entete">
          <NavLink exact to="/"><h1>{this.props.titre || "Titre du site"}</h1></NavLink>
          <nav className="menu">
              <BoutonNav lien="/" label="BtnNav Accueil" />
              <Link to="/">Accueil</Link>
              <BoutonNav lien="/compteur" label="BtnNav compteur" />
              <Link to="/compteur">Compteur</Link>
              <NavLink exact to="/compteur">Compteur (navLink)</NavLink>
              <BoutonNav lien="/information" label="BtnNav Info" />
              <Link to="/information">Information</Link>
              <NavLink exact to="/information">Information(navLink)</NavLink>
          </nav>
      </header>  
    );
  }
